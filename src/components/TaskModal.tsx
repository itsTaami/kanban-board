...
interface TaskModalProps {
  ...
  onMoveTask?: (taskId: string, targetColumnTitle: string) => Promise<void>;
  task?: Task | null;
  columnId: string;
  columnTitle?: string;
}
...
export function TaskModal({
  ...
  const handleRevertTask = async () => {
    ...
    setIsLoading(true);
    try {
      await onMoveTask(task.id, 'To Do');
      handleClose();
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-5">
          ...
          {isEditing && onMoveTask && (columnTitle === 'To Do' || columnTitle === 'In Progress' || columnTitle === 'Done') && (
              ...
              {columnTitle === 'In Progress' && (
                <>
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="flex-1 py-2.5 text-sm font-medium text-white
                      bg-gradient-to-r from-emerald-500 to-green-600 rounded-xl
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-700 mt-4">
            {isEditing && onDelete ? (
              <button
                ...
                className="p-2.5 text-red-400 hover:bg-red-900/20 rounded-xl transition-colors"
                title="Delete task"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
    ...
    {showDeleteConfirm && (
      ...
      >
        <div
          className="bg-slate-800 rounded-2xl shadow-2xl w-full max-w-sm border border-slate-700/50 animate-fade-in"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="p-6 text-center">
            <div className="mx-auto w-14 h-14 rounded-full bg-red-900/30 flex items-center justify-center mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-100 mb-2">Delete Task</h3>
            <p className="text-gray-400 mb-6">
              Are you sure you want to delete <span className="font-semibold text-gray-200">"{task?.title}"</span>? This action cannot be undone.
            </p>
            <div className="flex items-center justify-center gap-3">
              ...
              <button
                ...
                className="px-5 py-2.5 text-sm font-medium text-white
                  bg-gradient-to-r from-red-500 to-rose-600 rounded-xl
